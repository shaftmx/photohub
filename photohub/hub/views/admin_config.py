...
def _get_config(request):
    data = {
        ...
        "TRANSCODE_CODEC":             _get_config_value('TRANSCODE_CODEC'),
...
def _set_config(request):
    ...
    for key in ['RAW_PHOTOS_QUALITY', 'RAW_PHOTOS_MAX_SIZE', 'RAW_PHOTO_OVERRIDE_EXISTS', 'GENERATE_SAMPLES_ON_UPLOAD', 'ALLOW_VIDEO_UPLOAD', 'KEEP_ORIGINAL_VIDEO', 'TRANSCODE_POLL_INTERVAL', 'TRANSCODE_THREADS', 'TRANSCODE_CODEC', 'TRANSCODE_PRESET', 'TRANSCODE_CRF', 'TRANSCODE_TIMEOUT', 'GALLERY_PAGE_SIZE_DESKTOP', 'GALLERY_PAGE_SIZE_MOBILE', 'DISPLAY_PHOTO_SIZE', 'DISPLAY_PHOTO_SIZE_MOBILE', 'GRID_SIZE', 'GRID_MIN', 'GRID_MAX', 'GRID_SIZE_MOBILE', 'GRID_MIN_MOBILE', 'GRID_MAX_MOBILE']:
        if key in body:
